...
extern char *__DecodeSignedNumber(char *p, int *pnum);
...
extern char *__DecodeUnsignedNumber(char *p, unsigned int *pnum);
...
#if !__PACKED_EXCEPTION_TABLE
	
	/*	realign the pointer on the next word	*/
